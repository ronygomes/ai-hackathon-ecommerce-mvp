...
public class UpdateCartItemQtyHandler implements ICommandHandler<UpdateCartItemQtyCommand, Void> {
    private final ICartRepository repository;
    private final IMessageBus messageBus;

    @Inject
    public UpdateCartItemQtyHandler(ICartRepository repository, IMessageBus messageBus) {
