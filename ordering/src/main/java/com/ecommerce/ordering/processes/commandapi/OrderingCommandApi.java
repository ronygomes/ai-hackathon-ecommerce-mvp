package com.ecommerce.ordering.processes.commandapi;

import com.ecommerce.core.application.ICommandBus;
import com.ecommerce.core.infrastructure.RabbitMQCommandBus;
import com.ecommerce.ordering.application.PlaceOrderCommand;
...
public class OrderingCommandApi {
    public static void main(String[] args) {
        ...
        ICommandBus commandBus = new RabbitMQCommandBus("ordering_commands", "localhost");
